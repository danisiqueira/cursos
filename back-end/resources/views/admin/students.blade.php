    ...
    <div class="content">
        ...
        <table class="table table-light table-borderless table-striped table-hover">
            <thead class="table-dark">
                ...
                <th>Modelo</th>
                <th>Cor</th>
                <th>Carro id do Mortor</th>
                <th>Id do Mortor</th>
                <th>Posicionamento cilindros</th>
                <th>Cilindros</th>
                <th>Litragem</th>
                <th>Observacao</th>
            </thead>
            <tbody class="empty">
                @foreach($list as $item)
                    <tr>
                        ...
                        <td>{{$item[0]->modelo}}</td>
                        <td>{{$item[0]->cor}}</td>
                        <td>{{$item[0]->motor_id}}</td>
                        <td>{{$item[1]->id}}</td>
                        <td>{{$item[1]->posicionamento_cilindros}}</td>
                        <td>{{$item[1]->cilindros}}</td>
                        <td>{{$item[1]->litragem}}</td>
                        <td>{{$item[1]->observacao}}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
